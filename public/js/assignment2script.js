...
async function searchTasks(){
  ...
  await fetch('./allTasks', settings)
    ...
    console.log(tasks);
    let searchKey = document.querySelector('#taskSearch').value;
    let matches = findMatches(searchKey, tasks);
    ...
    for(match of matches){
      ...
      var textnode = document.createTextNode(match.taskName);         // Create a text node
